...
export function Login({ onLogin, onNavigateToRegister, onNavigateToAdminLogin }: LoginProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header showAuth={true} onRegisterClick={onNavigateToRegister} />
